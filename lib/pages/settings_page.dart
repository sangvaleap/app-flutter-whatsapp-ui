    ...
    return ListView(children: [
      Padding(
        ...
        child: Text(
          "Settings",
          style: TextStyle(
              fontSize: 28, color: white, fontWeight: FontWeight.bold),
        ),
      ),
      SizedBox(
        height: 10,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: AssetImage(profile[0]['img']),
                            fit: BoxFit.cover)),
                  ),
                  SizedBox(
                    width: 10,
      ...
      Column(
        ...
        return Container(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                (index>0) ? Padding(padding: const EdgeInsets.only(bottom: 10, left: 5, right: 5), child: Divider(color: white.withOpacity(0.5), height: 1,),) : Container(),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Row(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                (index == setting_section_two.length-1) ? SizedBox(height: 10,) : Container(),
              ],
            ),
          ),
        );
